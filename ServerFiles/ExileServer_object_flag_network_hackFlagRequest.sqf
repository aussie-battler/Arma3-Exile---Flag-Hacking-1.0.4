...
{	
    ...
    _index = -1;
    {
        if ((_x select 0) isEqualTo (_storedVehicleRandom select 0)) exitWith 
        {
    ...
    format["loadVehFromVG:%1", _storedVehicleRandom select 0] call ExileServer_system_database_query_fireAndForget;
